...
If Cal.com scan shows Tier 1 growing to more than 30 files with semantic promotion enabled, revisit the threshold or implement the index as a fallback.
...
- Post-Cal.com scan: measure Tier 1 file count with and without semantic promotion to calibrate whether any thresholds need adjustment.
