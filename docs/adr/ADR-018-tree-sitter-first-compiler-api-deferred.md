...
The language adapters reasoning document (Section 15, Decision 2) discusses this explicitly. Its recommendation is: "Use the TypeScript Compiler API for the main Cal.com adapter. Use Tree-sitter later for broader language coverage or faster structural fallback."
...
- Managing compilation errors in source files (Cal.com has linting errors that break `strict` mode compilation)
